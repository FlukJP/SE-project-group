...
router.put('/:id', authenticateJWT, requireVerified, uploadProductImage.array('images', 5), handleUploadError, validateImageMagicBytes, ProductController.updateProduct);
