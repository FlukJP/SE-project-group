...
// Renders a modal form for creating or editing a category, pre-populated when an existing category is provided
export default function CategoryFormModal({ open, category, onSave, onClose }: CategoryFormModalProps) {
    ...
    // Validates required fields and delegates saving to the onSave callback
