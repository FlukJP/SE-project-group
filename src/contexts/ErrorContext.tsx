...
// Returns the error context, providing access to the showError function.
export function useError() {
    return useContext(ErrorContext);
}

// Provides a global error modal trigger to the component tree.
...
// Renders a centered modal overlay displaying an error message with a dismiss button.
