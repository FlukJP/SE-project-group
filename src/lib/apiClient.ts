...
const THAI_ERROR_MESSAGES: MessageMatcher[] = [
  ...
  { match: "Email is required", text: "กรุณากรอกอีเมล" },
  { match: "Email already in use", text: "อีเมลนี้ถูกใช้งานแล้ว" },
  { match: "Phone number already in use", text: "เบอร์โทรนี้ถูกใช้งานแล้ว" },
