...
function ProfileInfo() {
  return (
    <>
      <h2 className="text-lg font-bold text-emerald-700 mb-6">
        ข้อมูลส่วนตัว
      </h2>
      ...
      <div className="space-y-5 max-w-xl">
        ...
        <button className="bg-emerald-600 text-white px-6 py-2 rounded-lg font-semibold">
          บันทึก
        </button>
      </div>
    </>
...
function AutoReply() {
  return (
    <>
      ...
      <Label>
        ข้อความที่ส่งอัตโนมัติเมื่อมีคนทักแชท
      </Label>
      ...
      <button className="bg-emerald-600 text-white px-6 py-2 rounded-lg font-semibold mt-4">
        บันทึก
      </button>
    </>
  )
    ...
    <>
      ...
      <div className="space-y-4 max-w-xl">
        <div className="flex items-center justify-between">
          <span>Facebook</span>
          <button className="border border-zinc-300 px-4 py-1.5 rounded-lg">
            เชื่อมต่อ
          </button>
        </div>
        ...
        <button className="border border-emerald-600 text-emerald-700 px-4 py-2 rounded-lg">
          เปลี่ยนรหัสผ่าน
        </button>
      </div>
    </>
